...
Dibangun dari satu frustrasi konkret: [InaRISK](https://inarisk.bnpb.go.id/) lambat, berat, dan memaksa kamu menelusuri banyak layer cuma untuk memahami satu kecamatan. JATINEGARA SIAGA membalik pendekatannya — **satu kecamatan, satu perjalanan** — dengan data yang bisa diaudit dan interaksi yang menjelaskan dirinya sendiri.
