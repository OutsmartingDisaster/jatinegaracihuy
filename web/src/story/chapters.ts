...
export const CHAPTERS: ChapterDef[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Peta mulai kosong. Pilih salah satu area untuk menyalakannya — hanya area itu yang tampil, supaya jelas di mana — lalu lihat mengapa risikonya setinggi itu, seberapa yakin kita pada angkanya, dan datanya seberapa baru.",
    ],
    camera: { center: STORY_CAMERA.center, zoom: STORY_CAMERA.zoom },
  ...
  },
  {
    ...
    body: [
      ...
      "Peta mulai kosong — klik salah satu dari tiga area untuk menyalakannya. Hanya area itu yang tampil.",
    ],
    camera: { center: STORY_CAMERA.center, zoom: STORY_CAMERA.zoom },
